...
const glasswingSource = await readFile(new URL('../theme/modules/glasswing.js', import.meta.url), 'utf8');
...
assert.deepEqual(
  createBaseline(scanJavaScriptSource({ filePath: 'theme/modules/glasswing.js', source: glasswingSource })),
  createBaseline(scanJavaScriptSource({ filePath: 'theme/modules/glasswing.js', source: formattedGlasswingSource })),
  'the exact Glasswing debt baseline must remain stable when the touched-legacy Prettier rule formats its theme file'
);
